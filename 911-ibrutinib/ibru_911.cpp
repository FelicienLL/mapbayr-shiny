...
CENTibru : Central compartment ibrutinib (mg/L) [OBS]
PERibru  : Perif compartment ibrutinib   ()
CENTdhd  : Central compartment DHD       (mg/L) [OBS]
...
$TABLE
PAR = (CENTibru / V2) * (1 + EPS(1)) * 1000 ;
MET = (CENTdhd  / V2) * (1 + EPS(3)) * 1000 ;
...
double CLF = (CLmet + CLibru) / (KAibru / (KAibru + KAdhd)) ;
